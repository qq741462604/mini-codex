...
import com.minicodex.domain.agent.AgentBatchResult;
import com.minicodex.domain.agent.AgentResult;
import com.minicodex.domain.agent.AgentTaskResult;
import com.minicodex.domain.agent.CodeChange;
import com.minicodex.interfaces.web.AgentRequest;
import com.minicodex.interfaces.web.AgentTaskRequest;
...
public class AgentBatchService {
  ...
  public boolean isBatchRequest(AgentRequest request) {
    return request != null && request.getTasks() != null;
  }
  ...
  public AgentResult run(AgentRequest request) {
    ...
    if (tasks.isEmpty()) {
      return buildResult(
          false, true, null, null, "batch tasks is empty", new ArrayList<>(), new ArrayList<>());
    }
  ...
  private AgentTaskResult toTaskResult(int index, String taskId, String task, AgentResult result) {
