...
@Component
/**
 * AnalysisPhaseHandler：负责 Agent 阶段规则和阶段流转。 所属层：应用层。
 *
 * @author yy
 */
public class AnalysisPhaseHandler implements AgentPhaseHandler {
  ...
  public AgentPhase next(AgentContext context) {
    ...
    boolean hasSearch =
        context.getObservations().stream().anyMatch(o -> "search_code".equals(o.getTool()));
