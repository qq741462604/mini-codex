...
@Component
/**
 * VerifyPhaseHandler：负责 Agent 阶段规则和阶段流转。 所属层：应用层。
 *
 * @author yy
 */
public class VerifyPhaseHandler implements AgentPhaseHandler {
  ...
  public AgentPhase next(AgentContext context) {
    Object result = context.getVariables().get("verify_result");
