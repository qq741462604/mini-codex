...
@Component
/**
 * CodingPhaseHandler：负责 Agent 阶段规则和阶段流转。 所属层：应用层。
 *
 * @author yy
 */
public class CodingPhaseHandler implements AgentPhaseHandler {
  ...
  @Override
  public AgentPhase next(AgentContext context) {

    boolean failedChange =
        context.getLastObservations().stream()
            .anyMatch(o -> isFileChangeTool(o.getTool()) && !o.isSuccess());
